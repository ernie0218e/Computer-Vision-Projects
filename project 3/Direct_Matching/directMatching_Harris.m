% Filename: directMatching_Harris
% Purpose: use matched harris features and their locations to estimate
...
for idx = 1:500
    ...
    % detect Surf feature
    points = detectHarrisFeatures(gray_frame);
    ...
    if maxInliers ~= 0
        hold on;
        % apply homography to the rectangle
